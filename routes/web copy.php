...
use Filament\Http\Livewire\AdminDashboard;
use App\Livewire\AuthSwitcher;
...
Route::middleware('guest')->group(function () {
    // Rute GET untuk 'login' akan dirender oleh Livewire AuthSwitcher
    // Ini yang akan memicu `mount()` di AuthSwitcher untuk menampilkan form login
    Route::get('login', AuthSwitcher::class)->name('login');

    // Rute GET untuk 'register' akan dirender oleh Livewire AuthSwitcher
    // Ini yang akan memicu `mount()` di AuthSwitcher untuk menampilkan form register
    Route::get('register', AuthSwitcher::class)->name('register');
});
